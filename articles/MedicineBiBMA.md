...
Medicine](articles/MedicineBMA.md) vignette.
...
distributions (see [`?prior_informed`](reference/prior_informed.md) for
...
[Reproducing BMA](articles/ReproducingBMA.md) and [Informed Bayesian
Model-Averaged Meta-Analysis in Medicine](articles/MedicineBMA.md)
vignettes.

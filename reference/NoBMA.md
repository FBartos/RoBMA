...
`NoBMA` is a wrapper around [`RoBMA()`](reference/RoBMA.md) that can be
used to estimate a publication bias unadjusted Bayesian model-averaged
...
See [`RoBMA()`](reference/RoBMA.md) for more details.

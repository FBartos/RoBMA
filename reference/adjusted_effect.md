...
RoBMA.reg and BiBMA.reg object. Only available for models estimated
using the spike-and-slab algorithm (i.e., `algorithm = "ss"`).
...
[`pooled_effect()`](reference/pooled_effect.md)

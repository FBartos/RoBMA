...
meta-regression. See
[`vignette("/MetaRegression", package = "RoBMA")`](doc/MetaRegression.md)
vignette describes how to use the similar
[`RoBMA.reg()`](reference/RoBMA.reg.md) function to fit Bayesian
meta-regression ensembles. See Bartoš et al. (2025) for more details
about the methodology and [`BiBMA()`](reference/BiBMA.md) for more
...
[`update.RoBMA()`](reference/update.RoBMA.md) function. Estimated
marginal means can be computed by
[`marginal_summary()`](reference/marginal_summary.md) function and
...
[`update.BiBMA()`](reference/update.BiBMA.md),

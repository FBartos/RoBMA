...
double cpp_wnorm_hierarchical_lpdf(double const *x, double const *theta, double const *se, double const *pop_mu, double const *pop_tau, double const *crit_x, double const *omega, const int J);

...
namespace jags {
  namespace RoBMA {
    ...
    std::vector<unsigned long> DWMN1::dim(std::vector<std::vector<unsigned long> > const &dims) const
    {
      return std::vector<unsigned long>(1,dims[0][0]);
    }


    bool DWMN1::checkParameterDim (std::vector<std::vector<unsigned long> > const &dims) const
    {
    ...
    bool DWMN1::checkParameterValue(std::vector<double const *> const &par, std::vector<std::vector<unsigned long> > const &dims) const
    {
    ...
    double DWMN1::logDensity(double const *x, PDFType type, std::vector<double const *> const &par,
    ...
    void DWMN1::randomSample(double *x, std::vector<double const *> const &par,
    ...
    void DWMN1::support(double *lower, double *upper,

...
namespace jags {
  namespace RoBMA {
    ...
    std::vector<unsigned long> DWMN1v::dim(std::vector<std::vector<unsigned long> > const &dims) const
    {
      return std::vector<unsigned long>(1,dims[0][0]);
    }


    bool DWMN1v::checkParameterDim (std::vector<std::vector<unsigned long> > const &dims) const
    {
    ...
    bool DWMN1v::checkParameterValue(std::vector<double const *> const &par, std::vector<std::vector<unsigned long> > const &dims) const
    {
    ...
    double DWMN1v::logDensity(double const *x, PDFType type, std::vector<double const *> const &par,
    ...
    void DWMN1v::randomSample(double *x, std::vector<double const *> const &par,
    ...
    void DWMN1v::support(double *lower, double *upper,

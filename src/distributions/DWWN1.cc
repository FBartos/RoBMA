...
bool DWWN1::checkParameterLength(std::vector<unsigned long> const &len) const
{
...
double DWWN1::logDensity(double const *x, PDFType type,
...
void DWWN1::randomSample(double *x,
			  std::vector<double const *> const &par,
...
void DWWN1::support(double *lower, double *upper,
	     std::vector<double const *> const &par,
	     std::vector<unsigned long> const &len) const
{
...
unsigned long DWWN1::length(std::vector<unsigned long> const &len) const
{

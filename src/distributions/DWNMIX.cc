...
bool DWNMIX::checkParameterLength(std::vector<unsigned long> const &len) const
{
...
// Log Density
double DWNMIX::logDensity(double const *x, PDFType type,
...
void DWNMIX::randomSample(double *x,
			  std::vector<double const *> const &par,
...
void DWNMIX::support(double *lower, double *upper,
	     std::vector<double const *> const &par,
	     std::vector<unsigned long> const &len) const
{
...
unsigned long DWNMIX::length(std::vector<unsigned long> const &len) const
{

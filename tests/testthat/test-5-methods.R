...
test_that("Marginal summary functions work", {
  ...
  expect_equal(
    ...
    c("Call:"                                                                                                                                                                           ,
      ...
      "mod_cat[B]     0.002  0.001 -0.064  0.080        0.130"                                                                                                                          ,
      "mod_cat[C]     0.845  0.870  0.569  1.021          Inf"                                                                                                                          ,
      "mod_con[-1SD] -0.087 -0.010 -0.299  0.000        0.065"                                                                                                                          ,
      "mod_con[0SD]   0.000  0.000  0.000  0.000        0.065"                                                                                                                          ,
      "mod_con[1SD]   0.087  0.012  0.000  0.299        0.066"                                                                                                                          ,
      "The estimates are summarized on the Cohen's d scale (priors were specified on the Cohen's d scale)."                                                                             ,
  ...
  expect_equal(
    ...
    c("Call:"                                                                                                                                                             ,
      ...
      "\033[0;31mModel (3): R-hat 4.875 is larger than the set target (2).\033[0m"                                                                                        ,
      "\033[0;31mModel (3): ESS 5 is lower than the set target (10).\033[0m"                                                                                              ,
      "\033[0;31mModel (3): MCMC error 1.24465 is larger than the set target (1).\033[0m"                                                                                 ,
      "\033[0;31mModel (6): R-hat 2.041 is larger than the set target (2).\033[0m"                                                                                        ,

...
test_that("Marginal summary functions work", {
  ...
  expect_equal(
    ...
    c("Call:"                                                                                                                                                             ,
      ...
      "Model-averaged marginal estimates:"                                                                                                                                ,
      "                Mean Median  0.025  0.975 Inclusion BF"                                                                                                            ,
      "intercept     -0.007 -0.002 -0.087  0.023        0.027"                                                                                                            ,
      "mod_con[-1SD] -0.424 -0.421 -0.483 -0.394          Inf"                                                                                                            ,
      "mod_con[0SD]  -0.007 -0.002 -0.087  0.023        0.029"                                                                                                            ,
      "mod_con[1SD]   0.414  0.417  0.350  0.443          Inf"                                                                                                            ,

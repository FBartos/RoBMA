...
This vignette overviews current features of the `RoBMA` package [@RoBMA].
The table is organized by substantive capability.
Some rows point to additional features not (yet) available `RoBMA` but featured in the `metafor` package [@metafor] as reference points.
...
rows <- list(
  ...
  feature_row("Priors", "Default priors", "YYYYYYY"),
  feature_row("Priors", "Empirical/informed priors (`prior_informed()`)", "YYYYYYY"),
  feature_row("Priors", "Custom priors (`prior()`, `prior_factor()`, `prior_weightfunction()`, `prior_none()`)", "YYYYYYY"),
  feature_row("Priors", "PET / PEESE priors (`prior_PET()`, `prior_PEESE()`)", "NNNYNNY"),

...
Raw outcome residuals are available on the derived effect-size scale, but standardized residuals and LOO-PIT diagnostics are unavailable until a discrete PIT convention is defined.
Estimate-unit `log_lik()`, LOO, and WAIC support accepted point and continuous nuisance priors; cluster-unit likelihood diagnostics remain unavailable.

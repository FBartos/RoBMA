...
The new version of the package uses product-space parameterization which greatly improves the estimation time by fitting all of the models simultaneously within one MCMC.
...
Furthermore, accounting for publication bias turns the previously found evidence for the overall effect into a weak evidence for the effect $\text{BF}_{10} = 1.25$ and notably reduces the mean effect estimate r = 0.061$, 95\% CI [-0.020, 0.189].

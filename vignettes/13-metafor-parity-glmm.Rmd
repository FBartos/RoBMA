...
Thus the default nuisance-parameter priors are exchangeable in the iid prior sense, but they are not hierarchical priors with a learned common baseline-rate distribution.

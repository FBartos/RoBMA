...
Formula-random correlations use `cor` in summaries, plots, density estimation, and hypotheses; any compact backend `rho` coordinate is internal. This differs from the legacy `cluster` model's public heterogeneity-allocation parameter `rho`.

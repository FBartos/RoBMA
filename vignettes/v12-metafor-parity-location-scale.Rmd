...
`parameter = "ni100", component = "scale"` selects the scale-side coefficient (use `component = "mods"` for the location side).

```{r scale-posterior, fig.width = 5, fig.height = 3.5}
par(mar = c(4, 4, 1, 1))
plot(fit2_brma, parameter = "ni100", component = "scale", prior = TRUE, xlim = c(-2, 2))
```

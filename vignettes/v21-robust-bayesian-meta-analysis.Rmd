...
The bias side of the ensemble concentrates posterior mass on PET (posterior probability $0.68$, individual inclusion BF $\approx 15$), followed by PEESE (posterior probability $0.21$); the remaining bias components together account for about $0.10$.

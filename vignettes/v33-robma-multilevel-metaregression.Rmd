...
The multilevel RoBMA meta-regression finds extreme evidence for the presence of the average effect, moderation by the degree of consumer contact, between-study heterogeneity, and publication bias (all BFs > 59,999).
...
The estimated marginal means reveal moderate evidence for the absence of an effect for jobs with no consumer contact ($\text{BF}_{10} = 0.10$) and extreme evidence for an effect for jobs with some or direct consumer contact.
The Bayes factors for the latter two groups rely on estimates from the tails of the posterior distributions and should not be interpreted precisely.

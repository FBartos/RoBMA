...
Evidence for the presence of an effect is undecided, with an inclusion Bayes factor of about 1.31.
The heterogeneity inclusion Bayes factor is about 8,000, but only three retained draws visit the homogeneous model and its estimated relative Monte Carlo error is 58%.
The heterogeneity indicator's R-hat is not assessable, so this large Bayes factor should not be treated as numerically precise.
The publication-bias inclusion Bayes factor is 5.15, indicating moderate evidence for publication bias.

...
MCMC diagnostics are included in the summary output. Visual diagnostics can be requested with `plot_diagnostic_trace()`, `plot_diagnostic_density()`, and `plot_diagnostic_autocorrelation()`.

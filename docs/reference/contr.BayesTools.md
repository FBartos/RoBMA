...
- `contr.orthonormal`:
  ...
  [`stanova::contr.bayes`](https://rdrr.io/pkg/stanova/man/contr.bayes.html)
  and corresponding to description by Rouder et al. (2012) . Returns a
  matrix with n rows and k columns, with k = n - 1 if `contrasts = TRUE`

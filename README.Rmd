...
See our manuscripts that for technical details and examples:
 ...
 - @bartos2023empirical (https://doi.org/10.48550/arXiv.2306.11468) outlines binomial-normal Bayesian model-averaged meta-analysis for binary outcomes (+ develops empirical prior distributions for log OR, log RR, RD, and log HR in medical settings, also see @bartos2021bayesian for empirical prior distributions for Cohen's d) 
